...
extern unsigned long __svgalib_linear_mem_phys_addr;
...
extern int __svgalib_linear_mem_fd;
...
extern void map_linear(int flags);
extern void map_banked(int flags);
extern void unmap_linear(void);
